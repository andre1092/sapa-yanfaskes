...
# --- 1.6 GLASSMORPHISM SIDEBAR ENGINE ---
def inject_glassmorphism_sidebar():
    """Inject premium Glassmorphism sidebar with responsive mini-variant (icon-only) toggle."""

    # ── A. MAIN CSS + JAVASCRIPT ────────────────────────────────────
    st.markdown("""
<style>
    /* ================================================================ */
    /*  BASE LAYOUT                                                      */
    ...
    /* ================================================================ */
    /*  GLASSMORPHISM SIDEBAR — always visible, fixed                    */
    /* ================================================================ */
    ...
    /* ================================================================ */
    /*  ICON COLUMN — visible only in mini-variant                      */
    /* ================================================================ */
    ...
    /* ================================================================ */
    /*  TYPOGRAPHY — pure white legibility                               */
    /* ================================================================ */
    section[data-testid="stSidebar"],
    ...
    /* ================================================================ */
    /*  INTERACTIVE MENU TILES — transparent clean tiles                 */
    /* ================================================================ */
    /* Radio option tiles */
    ...
    section[data-testid="stSidebar"] [data-baseweb="radio"] > div:first-child > div {
...
(function() {
    ...
    /* Apply immediately + after Streamlit re-renders */
    applySidebarState();
    setTimeout(applySidebarState, 150);
    setTimeout(applySidebarState, 500);
    setTimeout(applySidebarState, 1200);

    /* MutationObserver: re-apply class after DOM rebuilds (debounced) */
    ...
    /* Toggle click handler (delegated, single registration) */
...
""", unsafe_allow_html=True)
    ...
    # ── B. TOGGLE BUTTON (top of sidebar) ───────────────────────────
    st.sidebar.markdown("""
    ...
    # ── C. ICON COLUMN (visible only in mini-variant 70px state) ────
    st.sidebar.markdown("""
...
# Panggil fungsi setelah login berhasil
inject_glassmorphism_sidebar()
